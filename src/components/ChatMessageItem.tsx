      ...
      <div className="my-4 rounded-lg border border-border overflow-hidden font-sans bg-card">
        <div className="flex justify-between items-center bg-interactive-hover px-4 py-1.5 border-b border-border">
          ...
          <button
            ...
            className="p-1 text-text-secondary rounded-md hover:bg-border hover:text-text-primary transition-colors"
          >
        ...
        <div className="my-4 rounded-lg border border-border overflow-hidden bg-card">
            <div className="flex justify-between items-center px-4 py-2">
                ...
                <div className="flex items-center gap-1 text-text-secondary">
                    <button onClick={handleDownload} className="p-1.5 hover:bg-interactive-hover rounded-md" data-tooltip-text="Download" data-tooltip-position="top"><Download className="h-4 w-4" /></button>
                    <button onClick={handleCopy} className="p-1.5 hover:bg-interactive-hover rounded-md" data-tooltip-text="Copy" data-tooltip-position="top">
                        {copied ? <Check className="h-4 w-4 text-green-500" /> : <Copy className="h-4 w-4" />}
                    </button>
                    <button onClick={() => setIsCollapsed(!isCollapsed)} className="p-1.5 hover:bg-interactive-hover rounded-md" data-tooltip-text={isCollapsed ? "Expand" : "Collapse"} data-tooltip-position="top">
            ...
            <div>
                        ...
                        {msg.attachments!.map((att, attIndex) => (
                            <div key={attIndex} className="relative group max-w-sm">
                                ...
                                <a 
                                    href={att.dataUrl} 
                                    download={att.name}
                                    className="absolute top-2 right-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center gap-2 px-3 py-1.5 bg-black/60 text-white rounded-md text-sm hover:bg-black/80 backdrop-blur-sm"
                ...
                {!(isLoading && isLastMessage) && msg.content && !msg.projectFilesUpdate && !hasImageAttachment && (
                    <div className="mt-2 flex items-center gap-1 text-text-secondary">
                         <button
                            className="p-1.5 rounded-lg hover:bg-interactive-hover hover:text-text-primary transition-colors"
                            aria-label="Fork"
                            data-tooltip-text="Fork"
                            data-tooltip-position="top"
                        >
